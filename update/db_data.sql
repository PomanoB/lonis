DELETE FROM `kz_comm`;
INSERT INTO `kz_comm` (`name`, `url`, `image`, `download`, `map`) VALUES
	('cc', 'https://cosy-climbing.net', 'https://cosy-climbing.net/img/maps/%map%.png', 'https://cosy-climbing.net/files/maps/%map%.rar', 'https://cosy-climbing.net/search.php?q=%map%&in=&ex=&ep=&be=%map%&t=all&r=0&s=Search&adv=0'),
	('kz-rush', 'http://kz-rush.ru', 'http://kz-rush.ru/xr_images/maps/%map%.jpg', 'http://kz-rush.ru/maps/%map%', 'http://kz-rush.ru/maps/%map%'),
	('kzru', 'http://kzru.one', 'http://kzru.one/plugins/lgsl/lgsl_files/lgsl_image.php?map=%map%', 'http://kzru.one/maps/%map%', 'http://kzru.one/maps/%map%'),
	('xj', 'http://files.xtreme-jumps.eu', 'http://xtreme-jumps.eu/e107_plugins/lgsl_menu/images/mapz/halflife2/cstrike/%map%.jpg', 'http://files.xtreme-jumps.eu/maps/%map%.rar', 'http://xtreme-jumps.eu/demos_history/map_info.php?map=%map%');
