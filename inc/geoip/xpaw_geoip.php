...
class GeoIP {
	/********************************************
	 * GEOIP LIGHT by xPaw <xpaw.crannk.de>
	 *
	 * Speed tests:
	 *   5.0114 seconds - 65536 ips scanned - 48128 ips found - xPaw - Memory cached = true (default)
	 *   6.8765 seconds - 65536 ips scanned - 49636 ips found - xPaw - Memory cached = false
	...
	function __construct( $File, $CachedMemory = true ) {
	...
	function Country( $Ip ) {
		...
		return Array( 'id' => $Id, 'ip' => $Ip,
			'code' => $this->GEOIP_COUNTRY_CODES[ $Id ],
