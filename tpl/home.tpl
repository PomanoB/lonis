...
<div id="games" class="tabs">
	...
	<div>
		<img src="{$baseUrl}/{$dimg}/home/cs.png">
		<p>Это классический сервер, без лишних плагинов,
	...
	<div>
		<img src="{$baseUrl}/{$dimg}/home/dm.png">
	...
	<div>
		<img src="{$baseUrl}/{$dimg}/home/kz.png">
	...
	<div>
		<img src="{$baseUrl}/{$dimg}/home/zm.png">
